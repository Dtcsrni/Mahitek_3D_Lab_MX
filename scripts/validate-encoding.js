...
const FILES = [
  ...
  'assets/js/modules/health-report.js',
  'assets/js/modules/system-checks.js',
  'data/faq.json',
  'package.json'
...
console.log('OK Encoding OK (archivos críticos sin mojibake)');
