...
<svg class="nav-deco nav-nopal nav-nopal-left" viewBox="0 0 60 90">
  <path
    d="M30 10 C20 25 18 40 22 60 C26 78 18 82 16 90
...
<svg class="nav-deco nav-aguila" viewBox="0 0 60 50">
  <g filter="drop-shadow(0 0 12px rgba(6,182,212,0.6))">
    <path
      class="aguila-body"
      d="M28 24 Q30 14 34 10 Q38 14 40 24 Q36 22 32 22 Z"
    ...
    <path
      ...
      d="M30 20 Q12 18 8 30 Q18 26 26 28"
      fill="none"
      stroke="#00D9FF"
      stroke-width="2.2"
    ...
    <path
      ...
      d="M32 20 Q50 18 54 30 Q44 26 36 28"
      fill="none"
      stroke="#00D9FF"
      stroke-width="2.2"
      stroke-linecap="round"
...
<div class="badge-made-mx" role="img" aria-label="Hecho en Mexico">
  <svg class="badge-made-mx-svg" viewBox="0 0 160 32" preserveAspectRatio="xMidYMid meet">
    ...
    <text x="62" y="13" fill="#E0F2FE" font-size="10" font-weight="700" letter-spacing="0.6">
      HECHO EN
    </text>
    <text x="62" y="24" fill="#E0F2FE" font-size="12" font-weight="800" letter-spacing="0.8">
      MEXICO
    </text>
...
- `prefers-reduced-motion` implementado (verificado)
